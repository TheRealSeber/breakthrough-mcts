...
\begin{figure}[ht]
    ...
    gracza i parametrów (na zrzucie: UCT, gra białymi, 10\,000 iteracji,
    $c = \sqrt{2}$).}
    \label{fig:gui_setup}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Widok rozgrywki: plansza 8$\times$8 (z perspektywy gracza białego)
    oraz panel boczny z konfiguracją przeciwnika i statystykami partii na żywo.}
    \label{fig:gui_play}
\end{figure}
