...
\begin{frame}{Plan eksperymentów}
    ...
    H3 & heurystyka vs UCT & heur.\ + UCT \{500--100k\} & 2100 \\
...
\begin{frame}{H3: Heurystyka vs UCT}
    ...
    \begin{column}{0.38\textwidth}
        \small
        Heurystyka: 99\% $\to$ 94\% przy UCT od 500 do 100k iteracji.
        \vspace{1ex}
        \begin{itemize}\small
            \item Dominuje w całym praktycznym zakresie.
            \item Nawet przy 100k iteracji UCT \textbf{nie dogania} heurystyki ---
                  potrzebowałby wielokrotnie większego budżetu.
        \end{itemize}
        \werdykt{\partc}
    \end{column}
    \end{columns}
